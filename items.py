...
item_table = {
    ...
    SPMItem.RED_PURE_HEART: ItemData(ItemClassification.progression, 232),
    SPMItem.ORANGE_PURE_HEART: ItemData(ItemClassification.progression, 233),
    SPMItem.YELLOW_PURE_HEART: ItemData(ItemClassification.progression, 234),
    SPMItem.GREEN_PURE_HEART: ItemData(ItemClassification.progression, 235),
    SPMItem.CYAN_PURE_HEART: ItemData(ItemClassification.progression, 236),
    SPMItem.BLUE_PURE_HEART: ItemData(ItemClassification.progression, 237),
    SPMItem.PURPLE_PURE_HEART: ItemData(ItemClassification.progression, 238),
    SPMItem.WHITE_PURE_HEART: ItemData(ItemClassification.progression, 239),
