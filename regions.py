...
def get_locations(world: "SuperPaperMarioWorld") -> dict[str, list[str]]:
    ...
    return {
        ...
        SPMRegion.MI101: [SPMLocation.C21_CHEST_AFTER_SQUIGS, SPMLocation.C21_BOOMER_CHEST, SPMLocation.C21_CHEST_BEHIND_BOOMER_CHEST, SPMLocation.C21_LEFT_CHEST_BEFORE_STAR_BLOCK, SPMLocation.C21_RIGHT_CHEST_BEFORE_STAR_BLOCK, SPMLocation.C21_STAR_BLOCK],
        SPMRegion.MI201: [SPMLocation.C22_CHEST_ABOVE_ENTRANCE, SPMLocation.C22_CHEST_ON_ROOF, SPMLocation.C22_OPEN_ITEM_DRAGGED_BY_ROPE, SPMLocation.C22_OPEN_ITEM_HUNG_BY_ROPE, SPMLocation.C22_CHEST_ABOVE_SPIKE_ROOF, SPMLocation.C22_STAR_BLOCK],
