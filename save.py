...
MOD: set these on save creation instead of expecting the apworld to do it
"""
...
NEW_SAVE = frozenset(
    [
        GSW(
            0, 11
        ),  # Skips Merlon giving red heart, Tippi taking you to 1st Pillar and inserting heart, entering 1-1 door
